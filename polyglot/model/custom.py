...
StableId = Annotated[str, Field(pattern=r"^[A-Za-z0-9_-]+$")]


class AuthoritativeDefinition(PolyglotBaseModel):
...
class Description(PolyglotBaseModel):
    """Authoritative Definition."""
...
class CustomProperty(PolyglotBaseModel):
    """Custom Property"""
...
SemanticalVersion = Annotated[
    Optional[str],
    Field(pattern=SEMANTICAL_VERSION_PATTERN),
]
...
DATA_TYPES: dict = {
    ...
    "SemanticalVersion": {
        ...
        "physical": {
            "type": "VARCHAR",
            "pattern": SEMANTICAL_VERSION_PATTERN,
        },
    },
    "CustomProperties": {
